...
export class ThreeGameEngine {
  ...
  private init() {
    // 1. Create Scene & Atmospheric background colors matching a beautiful Roblox Space theme
    this.scene = new THREE.Scene();
    this.scene.background = new THREE.Color('#070614');
    this.scene.fog = new THREE.FogExp2('#070614', 0.0018);
    ...
    // 4. Setup Lighting
    this.ambientLight = new THREE.AmbientLight('#2a2845', 1.4); // soft ambient indigo fill
    this.scene.add(this.ambientLight);

    this.dirLight = new THREE.DirectionalLight('#decbff', 2.2); // strong warm sun
    ...
    // Subtle atmospheric floor grid just in the infinite void
    const gridHelper = new THREE.GridHelper(1000, 50, '#161330', '#0f0c24');
